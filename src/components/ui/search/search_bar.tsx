...
const SearchBar = () => {
  ...
  return (
    <aside className="md:w-[25%] flex flex-col font-main gap-6 bg-white shadow-xl border border-gray-200 h-[100vh] overflow-y-auto pt-[100px] sticky top-0 z-10 overflow-x-hidden asideScroll">
